...
public class RobotMap {
    ...
    public static WPI_TalonSRX leftIntakeMotor;
    public static WPI_TalonSRX rightIntakeMotor;
    
    // TODO Wire limit switches in parallel or separately?
    
    public static LIDARLiteV3 lidarSensor;

    public static WPI_TalonSRX climberMotor1;
    public static WPI_TalonSRX climberMotor2;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        leftIntakeMotor = new WPI_TalonSRX(5);
        rightIntakeMotor = new WPI_TalonSRX(6);
        climberMotor1 = new WPI_TalonSRX(9);
        climberMotor2 = new WPI_TalonSRX(10);
